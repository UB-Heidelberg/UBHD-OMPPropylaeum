...
settings.title = 'Propylaeum eBooks'
settings.subtitle = ''
settings.author_email = 'heiup@ub.uni-heidelberg.de'
settings.keywords = 'Propylaeum, Universitätsbibliothek Heidelberg, Universität Heidelberg, digitales Publizieren, Open Access, omp, python, mysql, knv, onix, arthistoricum'
settings.description = 'Propylaeum'
